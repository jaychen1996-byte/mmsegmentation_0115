...
def parse_args():
    ...
    parser.add_argument('--cityscapes_path',default="/home/jaychen/Desktop/DATASETS/cityscapes",
                        help='cityscapes data path')
    parser.add_argument('--gt-dir', default='gtFine', type=str)
    parser.add_argument('-o', '--out-dir', default="/home/jaychen/Desktop/DATASETS/cityscapes_transform",
                        help='output path')
    parser.add_argument(
